            ...
            <div className="flex justify-between items-center gap-2 w-full">
              {destination && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="bg-white flex item-center gap-2 text-black font-bold 
                    p-2 pl-4 pr-4 rounded-full opacity-70 hover:shadow-md"
                >
              ...
              {postedBy?._id === user.googleId && (
                <button
                  type="button"
                  className="bg-white opacity-70 hover:opacity-100 text-dark
                  font-bold p-2 text-base rounded-3xl hover:shadow-md outline-none"
                  onClick={(e) => {
                    e.stopPropagation();
                    deletePin(_id);
                  }}
